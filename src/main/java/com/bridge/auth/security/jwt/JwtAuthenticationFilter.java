...
import com.bridge.auth.security.UserPrincipal;
import com.bridge.auth.service.CustomManagerDetails;
import com.bridge.auth.service.RefreshTokenDto;
...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    private void handleAuthenticationException(HttpServletResponse response,
        ...
        if (e instanceof BadCredentialsException | e instanceof InternalAuthenticationServiceException) {
            CommonResponseDto<String> result = adminClient.getManagerIdById(username);
            if(result.isSuccess()) {
    ...
    private void processAuthenticationSuccess(Object principal, String userId, String username,
        ...
        CommonResponseDto responseDto = new CommonResponseDto(authentication.isAuthenticated(), principal);
